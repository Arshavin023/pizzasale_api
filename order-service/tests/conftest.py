...
async def mock_initialize_payment():
    """
    Auto-mock initialize_payment for all order-service tests.
    order_service.py calls payment-service synchronously at checkout —
    tests don't need a real payment-service running, just a mock response.
    """
    with patch(
        "app.services.order_service.initialize_payment",
